...
BUILD_DIR = build
GIT_BRANCH = gh-pages
GIT_PERSONAL_TOKEN = b67337473c5815db687a733851ce338c839afb0d
...
define show_deploy_url
    ...
    #)
    $(eval GIT_REPOSITORY_NAME := $(shell echo '$(GIT_REPOSITORY_REMOTE)' | cut -d "/" -f 2 | sed "s/.git//g" | sed "s/(push)//g"))
